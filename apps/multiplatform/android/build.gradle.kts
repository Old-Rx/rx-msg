...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders["provider_authorities"] = "com.oldrx.rxmsg.provider"
    ...
    buildTypes {
        debug {
            ...
            manifestPlaceholders["provider_authorities"] = "com.oldrx.rxmsg${rootProject.extra["application_id.suffix"]}.provider"
        }
        release {
